...
var require_daily_guards = __commonJS({
  "node_modules/@vapi-ai/web/dist/daily-guards.js"(exports) {
    ...
    function createSafeDailyConfig(config2) {
      if (!config2)
        return {};
      const { alwaysIncludeMicInPermissionPrompt, ...rest } = config2;
    ...
    var Vapi2 = class extends VapiEventEmitter {
      ...
      async increaseMicLevel(gain) {
        ...
        try {
          ...
          const destination = audioContext2.createMediaStreamDestination();
...
// src/voice-adapter.js
var import_web = __toESM(require_vapi());
var config = window.DREAMPROTOCOL_CONFIG || {};
var AUDIO_LOG = "[Dream Protocol audio]";
var SILENT_WAV = "data:audio/wav;base64,UklGRigAAABXQVZFZm10IBAAAAABAAEAQB8AAEAfAAABAAgAZGF0YQQAAACAgICA";
var vapi = null;
var listeners = [];
...
async function closeAudioContext() {
  ...
  if (context && context.state !== "closed") {
    try {
      ...
      diagnostic("AudioContext close failed.", error);
    }
  }
}
...
window.DreamProtocolVoiceAdapter = {
  ...
  async connect({ profile, onState, onTranscript, onComplete, onError, onAudioBlocked, onAudioReady }) {
    ...
    vapi = new import_web.default(config.vapiPublicKey);
    observeRemoteAudio();
    listen("call-start", () => {
