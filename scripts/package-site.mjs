...
for(const f of ['404.html','CNAME','.nojekyll','favicon.svg','robots.txt','sitemap.xml','resources/feed.xml','assets','public','demo-audio','btc','app.35e2b7721f.js','attribution.js'])copy(f);
